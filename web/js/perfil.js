...
import { ORIGEM, adotarMinhaLocalizacao, perfilPublico, postsDoPerfil,
         meuId, sair, meuPerfil, meuPapel } from './dados.js?v=69';
import { abrirEditarPerfil, abrirRecado } from './formularios.js?v=69';
import * as pwa from './pwa.js?v=69';
import { RAIO_AVISO_PADRAO } from './pwa.js?v=69';
